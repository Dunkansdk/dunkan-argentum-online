...
With UserList(userIndex)
    ...
    If PuedeConstruirHerreria(ItemIndex) Then
        ...
        If .Invent.WeaponEqpObjIndex <> 0 Then
           Call mod_DunkanItem.CheckearDuracion(.Invent.WeaponEqpSlot, userIndex)
        End If
            ...
            If res < 3 Then 'Exito robo
                ...
                Else 'Roba oro
                    If UserList(VictimaIndex).Stats.GLD > 0 Then
                        ...
                        'Roba oro, actualizo ranking ***
                         Dim targetRankPos As Byte
        
                        targetRankPos = mod_DunkanRankings.IngresaOro(LadrOnIndex)
        
                        If targetRankPos <> 0 Then Call mod_DunkanRankings.ActualizarOros(LadrOnIndex, targetRankPos)
