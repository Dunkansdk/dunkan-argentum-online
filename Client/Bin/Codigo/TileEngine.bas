...
Public SurfaceDB As New clsTexture_Manager ' Sacamos compression y toda esa parafernalia.
...
Public Type Char
    AnimTime    As Byte
    iParticle   As Integer  'ParticleIndex - maTIh.-
...
Sub CargarCascos()
    ...
    N = FreeFile()
    Open App.path & "\..\Resources\Init\Cascos.ind" For Binary Access Read As #N
...
Sub CargarCuerpos()
    ...
    N = FreeFile()
    Open App.path & "\..\Resources\Init\Personajes.ind" For Binary Access Read As #N
...
Sub CargarFxs()
    ...
    N = FreeFile()
    Open App.path & "\..\Resources\Init\Fxs.ind" For Binary Access Read As #N
...
Sub CargarTips()
    ...
    N = FreeFile
    Open App.path & "\..\Resources\Init\Tips.ayu" For Binary Access Read As #N
...
'**************************************************************
    ...
    Static alphaCount As Byte
    
    If Settings.Light_Radius = 1 Then
        If alphaCount < 150 Then
            alphaCount = alphaCount + 1
        End If
        Render_Radio (alphaCount)
    Else
    ...
    If Buy_Active Then RenderBuyMenu
...
'***************************************************
    ...
    With ConnectScreenRect
        .bottom = frmConnect.MainViewPic.ScaleHeight
        .Right = frmConnect.MainViewPic.ScaleWidth
    End With
...
On Error GoTo 0
    ...
    Call SurfaceDB.Initialize(DirectD3D8, ClientSetup.bUseVideo, DirGraficos, Settings.videoMemory)
...
Sub Engine_Show_NextFrame(ByVal DisplayFormTop As Integer, ByVal DisplayFormLeft As Integer, ByVal MouseViewX As Integer, ByVal MouseViewY As Integer)
    ...
    If EngineRun Then
        ...
        Engine_BeginScene ' Iniciamos
            ...
            ' // - Minimap
            Engine_Minimap_Build (ShowMinimap)
        ...
        If Mod_DX8_Ambiente.Fade Then Ambient_Fade
...
Dim X As Long, Y As Long
    ...
    Engine_EndScene ConnectScreenRect, frmConnect.MainViewPic.hWnd
