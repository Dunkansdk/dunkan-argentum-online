...
Public Memory As New clsMemoryManage
...
'    Resis As Byte
    ...
    ' maTih.-  /  Protección de memoria.
    Original_MaxHP  As Integer
    Original_MaxMan As Integer
...
Public Type ObjData
    ...
    OBJItem As mod_DunkanItem.ObjItems
...
'** TIPO DE INTERVALOS DE LOS USUARIOS **
Public Type tIntervals
  Pociones As Byte
  GolpeMagia As Byte
  MagiaGolpe As Byte
  MagiaMagia As Byte
  FlechaFlecha As Byte
  GolpePota As Byte
End Type
...
Public Type UserFlags
    ...
    '*** IA ***
    #If ConBots Then
    targetBOT       As Byte     '< Indice del bot clikeado
    #End If
    
    TargetEmbarcacion   As Byte
...
Type challangeUser
     Envio          As Boolean      'Mandó reto?
     EnReto         As Boolean      'Está retando?
     MeEnvio        As Integer      'UI De quien envia.
     Compañero      As Integer      'Compañero del que envia.
     Contrincante   As Integer      'Contrincante del otro team
     CContrincante  As Integer      'Compañero del contrincante
     Aceptaron      As Byte         'Cuantos aceptaron.
End Type
...
Public Type User
    ...
    Auto_Respawn    As Byte
    
    'Centinela - maTih.-
    CentinelaUsuario    As CentinelaUser
    
    'Retos
    UserReto    As challangeUser
    
    AtacoViajante   As Integer      'Index de bot que atacó.
...
#End If
    ...
    'NEW PARTYS!!
    IndexParty          As Integer
    SolicitandoParty    As Integer
    'NEW PARTYS!!
    ...
    KeyCrypt As Integer
    KeyCrypter As Long          'TIPO DE DATOS ES LONG.
...
Public Type MapBlock
    ...
    #If ConBots Then
    botIndex        As Byte         'BotIndex si hay bot.
    #End If
    
    EmbarcacionIndex    As Byte     'Num De Embarcacion
    
    Rutas(1 To 2)   As eHeading     'Rutas ?
