Attribute VB_Name = "Mod_DX8_Font"
Option Explicit
...
Dim TexInfo As D3DXIMAGE_INFO_A
    ...
    'Set the texture
    Set cfonts(1).Texture = DirectD3D8.CreateTextureFromFileEx(DirectDevice, App.path & "\..\Resources\Data\ExportedFont.bmp", D3DX_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_POINT, D3DX_FILTER_POINT, &HFF000000, ByVal 0, ByVal 0)
...
Dim V           As Single
    ...
    FileNum = FreeFile
    Open App.path & "\..\Resources\Data\FontData.dat" For Binary As #FileNum
