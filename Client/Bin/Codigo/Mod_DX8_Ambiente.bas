Attribute VB_Name = "Mod_DX8_Ambiente"
Option Explicit
    ...
    Select Case LastWeather
        ...
        Case 1  '// Lluvia
            If WeatherEffectIndex <= 0 Then
                WeatherEffectIndex = Effect_Rain_Begin(9, Settings.RainIntensity)
        ...
        Case 2  '// Nieve
            If WeatherEffectIndex <= 0 Then
                WeatherEffectIndex = Effect_Snow_Begin(15, Settings.SnowIntensity)
...
Dim c As Long
    ...
    For i = 1 To WeatherFogCount
        DDrawTransGrhIndextoSurface TempGrh.GrhIndex, (X * 512) + WeatherFogX1, (Y * 512) + WeatherFogY1, 1, Settings.FogIntensity
        X = X + 1
...
Minutos = Minute(Time)
    ...
    ElseIf SelectClase = True Then
        
        Ambient_SetFinal 120, 120, 120
