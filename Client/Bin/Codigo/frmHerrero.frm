...
Private Sub CargarImagenes()
    ...
    ImgPath = App.path & "\..\Resources\Graphics\"
...
For i = 1 To MAX_LIST_ITEMS
    If i + Inicio <= NumItems Then
        With ObjHerrero(i + Inicio)
            ...
            Call InvLingosHerreria(i).SetItem(1, 0, .LinH, 0, LH_GRH, 0, 0, 0, 0, 0, 0, "Lingotes de Hierro", True)
            Call InvLingosHerreria(i).SetItem(2, 0, .LinP, 0, LP_GRH, 0, 0, 0, 0, 0, 0, "Lingotes de Plata", True)
            Call InvLingosHerreria(i).SetItem(3, 0, .LinO, 0, LO_GRH, 0, 0, 0, 0, 0, 0, "Lingotes de Oro", True)
        End With
    End If
Next i
End Sub
