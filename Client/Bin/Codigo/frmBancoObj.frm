...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(App.path & "\..\Resources\Graphics\Boveda.jpg")
...
Private Sub LoadButtons()
    ...
    GrhPath = DirGraficos
    'CmdMoverBov(1).Picture = LoadPicture(App.path & "\..\Resources\Graphics\FlechaSubirObjeto.jpg") ' www.gs-zone.org
    'CmdMoverBov(0).Picture = LoadPicture(App.path & "\..\Resources\Graphics\FlechaBajarObjeto.jpg") ' www.gs-zone.org
