...
Public Particle_Cuenta  As Integer

Public QuestList()      As String
Public QuestInfo()      As String

Public SelectClase      As Boolean

Public Enum ParticleIndex    'Enumera los EffectIndex de los hechizos.
       eInmovilizar = 12    'Inmovilizar.
       eApocalipsis = 13    'Apocalipsis.
       eMeditarGRAN = 16    'Meditar grande.
       eMeditarGIGA = 34    'Meditar gigante.
End Enum
...
Public venta     As InvVenta
Public vendiendo As Boolean


'Inventarios de venta ***
Public InvVentaUser(1 To 2) As New clsGrapchicalInventory
...
Public Const INT_USEITEMU       As Integer = 0
