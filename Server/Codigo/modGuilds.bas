...
Dim AspiranteUI     As Integer
    ...
    If GuildPoints(gi) < 10 Then
       refError = "El clan no posee los guildPoints necesarios para aceptar este miembro"
       Exit Function
    End If
...
Public Function GuildPoints(ByVal GuildIndex As Integer) As Byte
GuildPoints = guilds(GuildIndex).getGpoints
End Function
