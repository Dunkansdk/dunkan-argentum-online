Attribute VB_Name = "Mod_DX8_Gore"
Option Explicit
...
'More info: http://www.vbgore.com/GameClient.TileEn ... icleEngine" class="postlink" rel="nofollow" onClick="window.open(this.href);return false;
'*****************************************************************
Dim i As Byte
    ...
    For i = 1 To UBound(ParticleTexture())
        ...
        Set ParticleTexture(i) = DirectD3D8.CreateTextureFromFileEx(DirectDevice, App.path & "/../Resources/Data/Particles/" & "p" & i & ".png", D3DX_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_POINT, D3DX_FILTER_POINT, &HFF000000, ByVal 0, ByVal 0)
    Next i
