...
Public Const CurServerPort = 7667
...
Public Function DirSound() As String
    DirSound = App.path & "\..\Resources\Wav\"
End Function
...
Public Function DirMapas() As String
    DirMapas = App.path & "\..\Resources\Mapas\"
End Function

Public Function DirExtras() As String
    DirExtras = App.path & "\..\Resources\Extras\"
End Function
...
' /  Note    : Calcular la posición de donde va a tirar el item
    ...
    If (Inventario.SelectedItem > 0 And Inventario.SelectedItem < MAX_INVENTORY_SLOTS + 1) Then
        ...
        Else
            Call Mod_DunkanProtocol.WriteDragToPos(X, Y, Inventario.SelectedItem, 1)
        End If
...
CurServerIp = frmConnect.Now_Server_Ip
...
Sub CargarArrayLluvia()
    ...
    N = FreeFile()
    Open App.path & "\..\Resources\init\fk.ind" For Binary Access Read As #N
...
On Error Resume Next
    ...
    arch = App.path & "\..\Resources\Init\" & "armas.dat"
...
On Error Resume Next
    ...
    archivoC = App.path & "\..\Resources\Init\colores.dat"
...
On Error Resume Next
    ...
    arch = App.path & "\..\Resources\Init\" & "escudos.dat"
...
'***************************************************
    ...
    Select Case Direccion
        ...
        Case E_Heading.NorthEast
            LegalOk = LegalPos(UserPos.X + 1, UserPos.Y - 1)
            
        Case E_Heading.SouthEast
            LegalOk = LegalPos(UserPos.X + 1, UserPos.Y + 1)
            
        Case E_Heading.NorthWest
            LegalOk = LegalPos(UserPos.X - 1, UserPos.Y + 1)
            
        Case E_Heading.SouthWest
            LegalOk = LegalPos(UserPos.X - 1, UserPos.Y - 1)
...
'*****************************************************************
    ...
    If UserMoving = 0 Then
        If Not UserEstupido Then
            ...
            If GetKeyState(vbKeyAdd) < 0 Then Engine_Zoom_In
            If GetKeyState(vbKeySubtract) < 0 Then Engine_Zoom_Out
            If GetKeyState(vbKeySpace) < 0 Then Engine_Zoom_Normal
            ...
            If GetKeyState(CustomKeys.BindedKey(eKeyType.mKeyUp)) < 0 Then
               ...
               '     Call MoveTo(NorthEast) ' Noreste .
               ' ElseIf GetKeyState(vbKeyLeft) < 0 Then
               '     Call MoveTo(SouthWest) ' Noroeste .
               ' Else
                    Call MoveTo(NORTH) ' Norte.
               ' End If
    ...
    For Y = YMinMapSize To YMaxMapSize
        For X = XMinMapSize To XMaxMapSize
            ...
            If ByFlags And 32 Then
                Get handle, , MapData(X, Y).Particle
                Effect_Begin MapData(X, Y).Particle, X, Y, 1, 100
            Else
                MapData(X, Y).Particle = 0
            End If
...
Sub WriteClientVer()
    ...
    hFile = FreeFile()
    Open App.path & "\..\Resources\Init\Ver.bin" For Binary Access Write Lock Read As #hFile
    Put #hFile, , CLng(777)
    Put #hFile, , CLng(777)
    Put #hFile, , CLng(777)
...
Sub Main()
    ...
    'Load config file
    If FileExist(App.path & "\..\Resources\Init\Inicio.con", vbNormal) Then
    ...
    Call AddtoRichTextBox(frmCargando.Status, "Buscando servidores... ", 150, 150, 150, False, False, True)
    
    Call AddtoRichTextBox(frmCargando.Status, "Hecho", 150, 150, 150, False, False, False)
    Call AddtoRichTextBox(frmCargando.Status, "Iniciando constantes... ", 150, 150, 150, False, False, True)
    ...
    Call AddtoRichTextBox(frmCargando.Status, "Iniciando motor gráfico... ", 150, 150, 150, False, False, True)
    
    If Not InitTileEngine(frmMain.MainViewPic.hWnd, 149, 13, 32, 32, 12, 16, 6, 8, 8, 0.02) Then
        Call CloseClient
    End If
    
    Call AddtoRichTextBox(frmCargando.Status, "Hecho", 150, 150, 150, False, False, False)
    
    Call AddtoRichTextBox(frmCargando.Status, "Creando animaciones extra... ", 150, 150, 150, False, False, True)
    ...
    Call AddtoRichTextBox(frmCargando.Status, "Iniciando DirectSound... ", 150, 150, 150, False, False, True)
    ...
    Call AddtoRichTextBox(frmCargando.Status, "                    ¡Bienvenido a Argentum Online!", 150, 150, 150, True, False, True)
...
'**************************************************************
    ...
    If FileExist(App.path & "\..\Resources\Init\ao.dat", vbArchive) Then
        fHandle = FreeFile
        
        Open App.path & "\..\Resources\Init\ao.dat" For Binary Access Read Lock Write As fHandle
...
'**************************************************************
    ...
    Open App.path & "\..\Resources\Init\ao.dat" For Binary As fHandle
