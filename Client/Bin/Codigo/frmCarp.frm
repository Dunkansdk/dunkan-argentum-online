...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(App.path & "\..\Resources\Graphics\VentanaCarpinteriaItems.jpg")
    LoadButtons
End Sub
...
For i = 1 To MAX_LIST_ITEMS
    If i + Inicio <= NumItems Then
        With ObjCarpintero(i + Inicio)
            ...
            ' Inventario de leños
            Call InvMaderasCarpinteria(i).SetItem(1, 0, .Madera, 0, MADERA_GRH, 0, 0, 0, 0, 0, 0, "Leña", True)
            Call InvMaderasCarpinteria(i).SetItem(2, 0, .MaderaElfica, 0, MADERA_ELFICA_GRH, 0, 0, 0, 0, 0, 0, "Leña élfica", True)
        End With
    End If
Next i
End Sub
