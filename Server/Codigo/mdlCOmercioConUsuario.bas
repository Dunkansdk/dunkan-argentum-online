    ...
    For OfferSlot = 1 To MAX_OFFER_SLOTS + 1
        ...
        With UserList(UserIndex)
            ...
            If OfferSlot = GOLD_OFFER_SLOT Then
                ...
                'Gana oro en comerio, actualizo ranking ***
                targetRankPos = mod_DunkanRankings.IngresaOro(OtroUserIndex)
        
                If targetRankPos <> 0 Then Call mod_DunkanRankings.ActualizarOros(OtroUserIndex, targetRankPos)
                ' Update Otro Usuario
